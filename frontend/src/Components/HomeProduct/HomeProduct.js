    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-auto max-w-screen-lg p-8 bg-white rounded-lg shadow-lg pt-16">
        ...
        <div className="flex flex-col">
          ...
          <button
            className={`flex mt-12 items-center justify-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded transition duration-300 shadow-md ${
