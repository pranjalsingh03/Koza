  ...
  if (loading) {
    ...
    product.name} />
                ...
                <div className="flex flex-col">
                    ...
                    <button
    className = {
        `flex mt-12 items-center justify-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded transition duration-300 shadow-md ${
            liked ? 'bg-pink-500 hover:bg-pink-600'
                  : ''}`} onClick = {handleLike} > < svg
    ...
    clipRule =
        ...
        button
    className =
        "bg-blue-500 mt-3 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded transition duration-300 shadow-md"
