...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      ></div>
      <ul
        className={`md:flex md:space-x-4 md:items-center md:pt-4 md:pr-4 md:border-l ${isOpen ? "fixed top-0 right-0 h-screen w-4/5 bg-zinc-900 p-4 z-50 flex-col justify-center" : "hidden"}`}
      >
        <li onClick={() => setMenu("home")}>
          <NavLink
            to="/home"
            className={`text-gray-700 ${isOpen ? "text-white" : "text-gray-700"}`}
        ...
        <li onClick={() => setMenu("newarrivals")}>
          <NavLink
            ...
            activeClassName="font-bold"
          >
            New Arrivals{menu === "newarrivals" ? <hr /> : <></>}
          </NavLink>
        </li>
